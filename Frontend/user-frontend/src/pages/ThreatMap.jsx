...
export default function ThreatMap() {
  ...
  useEffect(() => {
    const fetchThreats = async () => {
      try {
        const { data } = await api.get('/scan/threat-map');
        setThreats(data || []);
  ...
  return (
    <div className="h-screen flex flex-col p-6 bg-[#020617]">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-white">Your Threat Map</h1>
          <p className="text-slate-400 text-sm">Real-time visualization of threats from your scans.</p>
        </div>
